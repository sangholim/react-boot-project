...
import  './UserRegisterTemplate.css';
import axios from 'axios';

class UserRegisterTemplate extends Component {
  // 초기화
  state = {};
  ...
  doRegister = async () => {
    ...
    // 회원가입 성공후 다시 login 창으로 이동
    alert("회원가입 성공하였습니다.");
    this.props.handlePageType('login');
  };
    ...
    */
    return (
      <main className="register-form">
        ...
        <input value="회원가입" className="register" type="submit" onClick={this.doRegister}/>
		   </main>
